...
self.addEventListener("install", (event: ExtendableEvent) => { // eslint-disable-line no-shadow,no-inline-comments,line-comment-position
	event.waitUntil(
		caches
			.open(ASSETS)
...
self.addEventListener("activate", (event: ExtendableEvent) => { // eslint-disable-line no-shadow,no-inline-comments,line-comment-position
	event.waitUntil(
...
self.addEventListener("fetch", (event: FetchEvent) => { // eslint-disable-line no-shadow,no-inline-comments,line-comment-position
